      ...
      <div className="max-w-lg mx-auto px-4 space-y-4 pt-4">
        ...
        <div className="bg-slate-900 rounded-2xl p-5 space-y-4">
          <div className="flex items-center gap-4">
            <div className="w-16 h-16 rounded-full bg-slate-800 flex items-center justify-center text-2xl font-bold text-slate-400 overflow-hidden flex-shrink-0">
          ...
          {editing ? (
            <div className="space-y-4">
              <div className="space-y-2">
                <p className="text-xs text-slate-500 uppercase font-semibold">Medical Aid</p>
              ...
              <div className="space-y-2">
                <p className="text-xs text-slate-500 uppercase font-semibold">Hospital</p>
                <div className="grid grid-cols-2 gap-3">
              ...
              <div className="space-y-2">
                <p className="text-xs text-slate-500 uppercase font-semibold">Emergency Notes</p>
                <textarea
            ...
            <>
              ...
              {!profile.medical_aid_name && !profile.doctor_name && !profile.hospital_name && (
                <p className="text-sm text-slate-500 italic">No healthcare details added yet.</p>
              )}
            </>
          )}
        </div>
